...
'''
emr_spark_job = "s3://landingzonepinkal2000/Code/final_code.py"
dataset_to_be_processed="Actives"
dataset_path="Datasets/Actives/2022/February/17/Actives_17_Feb.parquet"
spark_config="Config/spark-config.json"
app_config="Config/app-config.json"
'''
...
def create_cluster(region_name, cluster_name='Pinkal_Cluster' + str(datetime.now()), release_label='emr-6.2.1',master_instance_type='m5.xlarge', num_core_nodes=1, core_node_instance_type='m5.xlarge',**kwargs):
        ...
        BootstrapActions= [
            {
                ...
                'ScriptBootstrapAction': {
                            'Path': 's3://landingzonepinkal2000/Dependency/dependencies.sh',
                        }
            }
			],
...
dag = DAG('AWS_Transformation', concurrency=3, schedule_interval=None, default_args=default_args)
...
def read_config(app_config):
    response = s3.Object('landingzonepinkal2000',app_config)
...
def create_emr(**kwargs):
    cluster_id = create_cluster(region_name='us-east-1', cluster_name='Pinkal_Cluster',  num_core_nodes=1)
    return cluster_id
...
create_cluster = PythonOperator(
    ...
    op_kwargs={'region_name':'us-east-1', 'cluster_name':'Pinkal_Cluster', 'num_core_nodes':1},
    dag=dag)
